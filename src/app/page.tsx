  ...
  return (
    <main className="w-full flex flex-col">
      {isClient && (
        ...
        className="w-full col-span-1 flex justify-center items-center p-20 max-lg:p-16 max-md:p-12 animate__animated"
      >
        <Image
          src={pic1}
          alt={"pekoraImg"}
      ...
      <div
        ...
        className="w-full max-lg:pl-0 max-lg:pt-20 max-sm:pt-1 col-span-1 animate__animated"
      >
        <div className="flex justify-center items-center w-full h-full flex-col p-20 max-lg:px-16 max-md:px-12 max-lg:pt-0">
          ...
          <div className="text-xl mt-10">
            An-An is a current student in Computer Engineering who loves coding, drawing, and designing. I’m interested in creating new innovations and possess strong leadership skills, along with the ability to effectively solve problems on the spot.
          </div>
        </div>
      </div>
          </div>
